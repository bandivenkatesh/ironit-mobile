...
class MockServices {
  ...
  static List<Service> getAllServices() {
    return <Service>[
      Service(
        ...
        description:
            'Professional ironing service for shirts with premium finish and crisp creases. Includes collar and cuff treatment.',
        price: 299.0,
        rating: 4.8,
        reviewCount: 128,
      ...
      Service(
        ...
        description:
            'Perfect creases for formal trousers and pants. Includes steam treatment for wrinkle-free finish.',
        price: 399.0,
        rating: 4.7,
        reviewCount: 95,
      ...
      Service(
        ...
        categoryId: 'category-2',
        description:
            'Delicate steaming for business suits to maintain fabric quality and remove wrinkles without direct heat.',
        price: 799.0,
        rating: 4.9,
        reviewCount: 210,
      ...
      Service(
        ...
        description:
            'Quick and affordable ironing for casual t-shirts and polo shirts. Perfect for everyday wear.',
        price: 199.0,
        rating: 4.5,
        reviewCount: 87,
      ...
      Service(
        ...
        categoryId: 'category-3',
        description:
            'Specialized pressing for jeans to maintain shape and create sharp creases without damaging fabric.',
        price: 249.0,
        rating: 4.6,
        reviewCount: 63,
      ...
      Service(
        ...
        description:
            'Gentle steaming for delicate silk dresses and blouses. Preserves fabric integrity while removing wrinkles.',
        price: 899.0,
        rating: 4.9,
        reviewCount: 142,
      ...
      Service(
        ...
        description:
            'Professional ironing for bed sheets with hospital corners and crisp finish. Available for all sizes.',
        price: 499.0,
        rating: 4.7,
        reviewCount: 115,
      ...
      Service(
        ...
        categoryId: 'category-5',
        description:
            'Large tablecloth ironing with perfect creases and stain treatment options. Ideal for events and restaurants.',
        price: 799.0,
        rating: 4.8,
        reviewCount: 48,
  ...
  static List<Service> getFeaturedServices() {
    return getAllServices()
        .where((Service service) => service.isFeatured)
        .toList();
  }
  ...
  static List<Service> getPopularServices() {
    return getAllServices()
        .where((Service service) => service.isPopular)
        .toList();
  }
  ...
  static List<Service> getServicesByCategory(String categoryId) {
    return getAllServices()
        .where((Service service) => service.categoryId == categoryId)
        .toList();
  }
  ...
  static List<Service> searchServices(String query) {
    ...
    return getAllServices().where((Service service) {
  ...
  static Service? getServiceById(String id) {
    try {
      return getAllServices().firstWhere((Service service) => service.id == id);
    } catch (e) {
      return null;
    }
  }
